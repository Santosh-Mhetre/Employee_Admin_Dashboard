  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex items-center text-sm text-gray-600 mb-4">
        ...
        <span className="mx-2">/</span>
        <Link href={`/employees/${id}`} className="hover:text-blue-600">Employee Details</Link>
        <span className="mx-2">/</span>
            ...
            <div className="bg-white p-4 rounded-lg mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea placeholder="Enter current address" {...register('currentAddress', { required: 'Current address is required' })} rows={1} className="w-full p-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black"></textarea>
